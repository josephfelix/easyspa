...
sEmptyTable:"No data available in table",sInfo:"Exibindo _START_ a _END_ de _TOTAL_ resultados",sInfoEmpty:"Exibindo 0 a 0 de 0 resultados",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Exibindo _MENU_ resultados",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Não há resultados a exibir"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
