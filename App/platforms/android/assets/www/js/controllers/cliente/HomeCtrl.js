...
.controller('HomeClienteCtrl', function($scope, $rootScope, $ionicModal, $timeout, $location, $http, $cordovaInAppBrowser, $ionicPlatform)
{
	$rootScope.$on('$stateChangeStart', function(event, toState, toParams, fromState, fromParams){
		if ( toState.name == 'app.cliente.home' )
		{
