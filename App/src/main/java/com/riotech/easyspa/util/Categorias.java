...
public class Categorias {
    public static final int ID_CAT_PES_E_MAOS = 1;
    public static final int ID_CAT_ACADEMIAS = 2;
    public static final int ID_CAT_ACUPUNTURA = 3;
    public static final int ID_CAT_CABELEIREIRO = 4;
    public static final int ID_CAT_CILIOS = 5;
    public static final int ID_CAT_CLINICA_ESTETICA = 6;
    public static final int ID_CAT_DENTISTA = 7;
    public static final int ID_CAT_DEPILACAO = 8;
    public static final int ID_CAT_DESIGN_DE_SOBRANCELHAS = 9;
    public static final int ID_CAT_ESTETICA_CORPORAL = 10;
    public static final int ID_CAT_ESTETICA_FACIAL = 11;
    public static final int ID_CAT_FISIOTERAPIA = 12;
    public static final int ID_CAT_HIDROTERAPIA = 13;
    public static final int ID_CAT_MAQUIAGEM = 14;
    public static final int ID_CAT_MASSAGEM = 15;
    public static final int ID_CAT_NUTRICIONISTA = 16;
    public static final int ID_CAT_PERSONAL_TRAINER = 17;
    public static final int ID_CAT_PIERCING = 18;
    public static final int ID_CAT_PRATICAS_INTEGRATIVAS = 19;
    public static final int ID_CAT_SALAO_DE_BELEZA = 20;
    public static final int ID_CAT_SPA = 21;
    public static final int ID_CAT_YOGA = 22;
